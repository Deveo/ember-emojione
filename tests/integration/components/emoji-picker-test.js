...
test('it should switch tones', withChai(function(expect) {
  ...
  expect(component.contains('span[title=":v:"]'), m).true;

  m = "Initially should not contain toned emoji";
  expect(component.contains('span[title=":v_tone1:"]'), `${m} (trying tone 1)`).false;
  expect(component.contains('span[title=":v_tone2:"]'), `${m} (trying tone 2)`).false;
  expect(component.contains('span[title=":v_tone3:"]'), `${m} (trying tone 3)`).false;
  expect(component.contains('span[title=":v_tone4:"]'), `${m} (trying tone 4)`).false;
  expect(component.contains('span[title=":v_tone5:"]'), `${m} (trying tone 5)`).false;

  component.tones(1).click();

  m = "Should contain tone 1 emoji after click on tone 1";
  expect(component.contains('span[title=":v_tone1:"]'), m).true;

  m = "Should not contain emoji of other tones after click on tone 1";
  expect(component.contains('span[title=":v:"]'),       `${m} (trying toneless)`).false;
  expect(component.contains('span[title=":v_tone2:"]'), `${m} (trying tone 2)`).false;
  expect(component.contains('span[title=":v_tone3:"]'), `${m} (trying tone 3)`).false;
  expect(component.contains('span[title=":v_tone4:"]'), `${m} (trying tone 4)`).false;
  expect(component.contains('span[title=":v_tone5:"]'), `${m} (trying tone 5)`).false;
  ...
  expect(component.contains('span[title=":v_tone2:"]'), m).true;
  ...
  expect(component.contains('span[title=":v_tone3:"]'), m).true;
  ...
  expect(component.contains('span[title=":v_tone4:"]'), m).true;
  ...
  expect(component.contains('span[title=":v_tone5:"]'), m).true;
